...
<header>
    <div id="head-line-2">
        ...
        Hello, Dima Kruhlyi! Now you can add new settlement & population to database!
    </div>
</header>
    ...
    if ($_POST) //Условие будет выполнено, если произведен POST-запрос к скрипту.
    {
        ...
        if ($error)
        {
            ...
            if ($sql)
            {
                ...
                exit ('<div style = " position:relative; top:250px; left:40%; background:black; color:white; font-family:ALGERIAN; height: 50px; width: 700px;
border-radius: 50%;"><h3>
